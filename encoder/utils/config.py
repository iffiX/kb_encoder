...
class OpenBookQAChainedSequenceTrainConfig(BaseModel):
    load: bool = False
    seed: int = 0
    save: bool = True
    save_last: bool = False
...
class OpenBookQAChainedSequenceFactTrainConfig(BaseModel):
    load: bool = False
    seed: int = 0
    save: bool = True
    save_last: bool = False
...
class Config(BaseModel):
    ...
    configs: List[
        Union[
            ...
            OpenBookQAChainedSequenceTrainConfig,
            OpenBookQAChainedSequenceFactTrainConfig,
            ARCTrainConfig,
...
def stage_name_to_config(name: str, config_dict: dict = None):
    stage_name_to_config_map = {
        ...
        "openbook_qa_chained_sequence": OpenBookQAChainedSequenceTrainConfig,
        "openbook_qa_chained_sequence_fact": OpenBookQAChainedSequenceFactTrainConfig,
        "arc": ARCTrainConfig,
