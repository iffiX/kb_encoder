...
from .download import OpenBookQA
...
class OpenBookQASearchDataset:
    def __init__(
        ...
        archive_path = os.path.join(preprocess_cache_dir, "openbook_qa_search.data")
    ...
    def save_search_targets(self, choice: t.Tensor):
        ...
        with open(
            os.path.join(preprocess_cache_dir, f"openbook_qa_targets.json"), "w",
        ) as file:
